package com.peregud.shoppingmall.specification;

import com.peregud.shoppingmall.domain.Shop;
import com.peregud.shoppingmall.domain.Shop_;
        ...
        return (root, criteriaQuery, criteriaBuilder) -> {
            ...
            if (StringUtils.isNotBlank(search)) {
                predicateList.add(criteriaBuilder.like(criteriaBuilder.lower(
                        root.get(Shop_.NAME)), "%" + search.toLowerCase() + "%"));
                predicateList.add(criteriaBuilder.like(criteriaBuilder.lower(
                        root.get(Shop_.DESCRIPTION)), "%" + search.toLowerCase() + "%"));
            }
